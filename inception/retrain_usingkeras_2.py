...
name_save_predictions_3 = ''.join(['predictions_keras2_', '_', str(idx), '_', str(value), '_.csv'])
...
real_val = '/home/william/m18_jorge/Desktop/THESIS/DATA/real_values/Real_values_validation_no_dataaugment.csv'
