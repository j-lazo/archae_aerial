# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 17:44:54 2019
...
batch = 100
train_labels_len = len([os.listdir(train_data_dir)])
bottleneck_features_train = model.predict_generator(train_gen, 
                                                    train_labels_len // batch)
models_location = os.getcwd()
np.save(models_location + 'bottleneck_f_train_inception', bottleneck_features_train)                                                    
...
# -------- optimizers, choose what you want ---------------
adam = Adam(lr=0.001)
